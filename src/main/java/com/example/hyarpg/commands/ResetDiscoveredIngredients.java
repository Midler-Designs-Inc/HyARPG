...
public class ResetDiscoveredIngredients extends CommandBase {

    private final RequiredArg<String> PLAYER;

    public ResetDiscoveredIngredients() {
        // Name, Description
        super("HyARPG_Reset_Discovered_Ingredient", "Reset all discovered ingredients for a given player. This allows recipe discovery to refire.", false);
    ...
    protected void executeSync(@Nonnull CommandContext commandContext) {
        ...
        world.execute(() -> {
            ...
            craftingKnowledge.resetDiscoveredItems();
        });
    }
}
