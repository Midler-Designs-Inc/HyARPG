...
import com.example.hyarpg.ui.HyARPGDashboardUI;

import javax.annotation.Nonnull;

/**
 * /hya ui - Open the plugin dashboard UI
 *
...
public class UISubCommand extends AbstractPlayerCommand {
    ...
    protected void execute(
        ...
        context.sendMessage(Message.raw("Opening HyARPG Dashboard..."));
        ...
        try {
            ...
            HyARPGDashboardUI dashboardPage = new HyARPGDashboardUI(playerRef);
