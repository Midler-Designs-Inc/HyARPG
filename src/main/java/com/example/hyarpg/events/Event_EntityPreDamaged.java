...
public class Event_EntityPreDamaged {
    ...
    public Event_EntityPreDamaged(Ref<EntityStore> attacker, Ref<EntityStore> defender, Store<EntityStore> store, CommandBuffer<EntityStore> commandBuffer, Damage damage) {
