...
public class Event_PlayerInventoryItemAdded {
    ...
    public Event_PlayerInventoryItemAdded(Ref<EntityStore> ref, Store<EntityStore> store, ItemContainer.ItemContainerChangeEvent changeEvent, short slot, ItemStack stack) {
        this.ref = ref;
        this.store = store;
