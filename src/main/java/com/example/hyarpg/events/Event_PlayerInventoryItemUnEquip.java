...
public class Event_PlayerInventoryItemUnEquip {
    ...
    public Event_PlayerInventoryItemUnEquip(Ref<EntityStore> ref, Store<EntityStore> store, ItemContainer.ItemContainerChangeEvent changeEvent, short slot, ItemStack stack) {
        this.ref = ref;
        this.store = store;
