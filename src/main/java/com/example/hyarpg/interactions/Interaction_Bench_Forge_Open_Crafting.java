...
public class Interaction_Bench_Forge_Open_Crafting extends SimpleInstantInteraction {
    ...
    public static final BuilderCodec<Interaction_Bench_Forge_Open_Crafting> CODEC = BuilderCodec.builder(
        Interaction_Bench_Forge_Open_Crafting.class,
        Interaction_Bench_Forge_Open_Crafting::new,
