...
public class Interaction_RestoreThirstT3 extends SimpleInstantInteraction {
    // Create the CODEC - this is required for serialization
    public static final BuilderCodec<Interaction_RestoreThirstT3> CODEC = BuilderCodec.builder(
            Interaction_RestoreThirstT3.class,
            Interaction_RestoreThirstT3::new,
    ...
    protected void firstRun(
        ...
        // restore some thirst
        float value = (float) (thirst.max * ModConfig.get().thirst.restore_t3_percent);
