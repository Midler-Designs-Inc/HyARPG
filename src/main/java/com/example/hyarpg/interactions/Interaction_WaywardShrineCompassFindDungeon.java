...
public class Interaction_WaywardShrineCompassFindDungeon extends SimpleInstantInteraction {
    ...
    public static final BuilderCodec<Interaction_WaywardShrineCompassFindDungeon> CODEC = BuilderCodec.builder(Interaction_WaywardShrineCompassFindDungeon.class, Interaction_WaywardShrineCompassFindDungeon::new, SimpleInstantInteraction.CODEC).build();
    ...
    protected void firstRun(@NonNullDecl InteractionType interactionType, @NonNullDecl InteractionContext context, @NonNullDecl CooldownHandler cooldownHandler) {
        ...
        world.execute(() -> {
            // bail out if the registry or world generator aren't available yet
            ...
            // get the chunk generator so we can get the surface y
            ...
            // determine if the player is underground and pick the right dungeon type to search
            ...
            PrefabRecord.Type type = underground ? PrefabRecord.Type.UNDERGROUND_DUNGEON : PrefabRecord.Type.SURFACE_DUNGEON;

            // find the closest dungeon and point the compass at it
            ...
            // convert the position delta to a cardinal direction and send the result
    ...
    // get the direction based on an angle
