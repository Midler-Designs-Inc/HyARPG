...
public class Interaction_WaywardShrineCompassFindDungeon extends SimpleInstantInteraction {
    ...
    protected void firstRun(@NonNullDecl InteractionType interactionType, @NonNullDecl InteractionContext context, @NonNullDecl CooldownHandler cooldownHandler) {
        ...
        world.execute(() -> {
            ...
            int regionSize = underground ? cfg.prefabUndergroundDungeonRegionSize : cfg.prefabSurfaceDungeonRegionSize;
            double chance  = underground ? cfg.prefabUndergroundDungeonSpawnChance : cfg.prefabSurfaceDungeonSpawnChance;
            long salt      = underground ? 0x5L                                    : 0x4L;
