...
public class CustomForgeSalvagePage extends InteractiveCustomUIPage<CustomForgeSalvagePage.PageData> implements ItemContainerWindow {
    ...
    public CustomForgeSalvagePage(@Nonnull PlayerRef playerRef) {
